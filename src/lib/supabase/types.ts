...
// Table: projects
//   FOREIGN KEY projects_analyst_id_fkey: FOREIGN KEY (analyst_id) REFERENCES colaboradores(id) ON DELETE SET NULL
...
//   FOREIGN KEY tasks_responsible_id_fkey: FOREIGN KEY (responsible_id) REFERENCES colaboradores(id) ON DELETE SET NULL
// Table: time_entries
